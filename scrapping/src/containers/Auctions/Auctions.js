...
class Auctions extends Component {
    ...
    timer = (index) => {
        ...
        // document.getElementById('countdown').innerHTML = hour +"h" + " " + minutes + "m" + " " + remainingSeconds + "s";
        // console.log(hour +"h" + " " + minutes + "m" + " " + remainingSeconds + "s")
        if (seconds == 0) {
            console.log("if")
    ...
    return_string = (prices) => {
        var pri1 = prices[0] + "     " + prices[3] + "\n" +  prices[4] + "\n" + prices[1] + prices[2]
    }
